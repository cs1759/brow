...
const getURL = async (browser) => {
    ...
    if (browser == 'chrome') {
        try {
            ...
            var string = await exec(String.raw`.\chrome-session-dump.exe -active "C:\Users\91790\AppData\Local\Google\Chrome\User Data\Default\Extensions\efaidnbmnnnibpcajpcglclefindmkaj\15.1.3.2_0\lib\session.js" `)
            return string;
        }
    }
